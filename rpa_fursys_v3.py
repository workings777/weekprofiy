...
USERNAME     = "csk830"
PASSWORD     = "sidiz12!!"
DOWNLOAD_DIR = r"C:\Users\FURSYS\Desktop\kyun\weels_profit_2\input"
OUTPUT_DIR   = r"C:\Users\FURSYS\Desktop\kyun\weels_profit_2\output"
# ============================================================
...
def run_erp():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            erp_page.wait_for_load_state("networkidle", timeout=60000)
            erp_page.wait_for_timeout(1000)
            print(f"      ✅ 조회 완료")

            # ── STEP 5: 엑셀 다운로드 ─────────────────────────
            print(f"\n[5/5] 📥 엑셀 다운로드")
            erp_page.get_by_text("1", exact=True).first.click(button="right")
